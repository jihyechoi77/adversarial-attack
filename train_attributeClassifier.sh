...
# python model_train.py --loss 'binary_crossentropy_custom' --save_name 'VGG16-dim160-attrClassifier-customloss'
# python model_evaluate.py --model_name 'VGG16-dim160-attrClassifier-customloss'


# InceptionV3
# python model_train.py --model_type InceptionV3 --save_name 'InceptionV3-dim160-attrClassifier' --epoch 50
# python model_evaluate.py --model_name 'InceptionV3-dim160-attrClassifier'

# python model_train.py --model_type InceptionV3 --save_name 'InceptionV3-dim160-attrClassifier-customloss' --epoch 50
